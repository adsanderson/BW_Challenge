...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeShape = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TagCloud = __webpack_require__(177);
	
	var _TagCloud2 = _interopRequireDefault(_TagCloud);
	
	var _actions = __webpack_require__(179);
	
	var topicActions = _interopRequireWildcard(_actions);
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)(topicActions, dispatch);
	}
	
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_TagCloud2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MetaData = __webpack_require__(178);
	
	var _MetaData2 = _interopRequireDefault(_MetaData);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var TagCloud = _react2.default.createClass({
		displayName: 'TagCloud',
		componentDidMount: function componentDidMount() {
			this.props.fetchTopics();
		},
		handleListItemClick: function handleListItemClick(index) {
			this.props.selectTopic(index);
		},
		render: function render() {
			var _this = this;
	
			var _props$topics = this.props.topics;
			var topics = _props$topics.topics;
			var selectedTopic = _props$topics.selectedTopic;
	
			var topicsNodes = topics.map(function (topic, index) {
				var listItemProps = {
					key: topic.id,
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_MetaData2.default, metaDataProps)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MetaData = _react2.default.createClass({
					...
					return _react2.default.createElement(
							...
							_react2.default.createElement(
									...
									_react2.default.createElement(
											...
											null,
											'Positive mentions: ',
											topic.sentimentPositive || 0
									),
									_react2.default.createElement(
											'li',
											null,
											'Neutral mentions: ',
											topic.sentimentNeutral || 0
									),
									_react2.default.createElement(
											'li',
											null,
											'Negative mentions: ',
											topic.sentimentNegative || 0
									)
							)
					);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SELECT_TOPIC = exports.RECEIVE_TOPICS = exports.REQUEST_TOPICS = undefined;
	exports.selectTopic = selectTopic;
	...
	var _mapTopicsJsonToState = __webpack_require__(215);
	
	var _mapTopicsJsonToState2 = _interopRequireDefault(_mapTopicsJsonToState);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var REQUEST_TOPICS = exports.REQUEST_TOPICS = 'REQUEST_TOPICS';
	var RECEIVE_TOPICS = exports.RECEIVE_TOPICS = 'RECEIVE_TOPICS';
	var SELECT_TOPIC = exports.SELECT_TOPIC = 'SELECT_TOPIC';
	...
	function fetchTopics() {
		return function (dispatch) {
			...
			return (0, _isomorphicFetch2.default)('topics.json').then(function (response) {
				return response.json();
			}).then(function (json) {
				return dispatch(receiveTopics(json));
			});
		};
	}
	...
	function receiveTopics(json) {
		return {
			type: RECEIVE_TOPICS,
			topics: (0, _mapTopicsJsonToState2.default)(json.topics)
		};
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var realFetch = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parse_url = __webpack_require__(182).parse;
	var resolve_url = __webpack_require__(182).resolve;
	var http = __webpack_require__(183);
	...
	var Headers = __webpack_require__(213);
	var Request = __webpack_require__(214);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var http = __webpack_require__(183);
	var convert = __webpack_require__(188).convert;
	var Headers = __webpack_require__(213);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var iconvLite = __webpack_require__(189);
	var Iconv;
	
	try {
	    // this is to fool browserify so it doesn't try (in vain) to install iconv.
	    var iconv_package = 'iconv';
	    Iconv = __webpack_require__(212)(iconv_package).Iconv;
	} catch (E) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (iconv) {
	    ...
	    iconv.extendNodeEncodings = function extendNodeEncodings() {
	        ...
	        // -- SlowBuffer -----------------------------------------------------------
	        var SlowBuffer = __webpack_require__(211).SlowBuffer;
	        ...
	        if (iconv.supportsStreams) {
	            var Readable = __webpack_require__(186).Readable;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = mapTopicsJsonToState;
	
	var _reduceToMinAndMaxValue = __webpack_require__(216);
	
	var _reduceToMinAndMaxValue2 = _interopRequireDefault(_reduceToMinAndMaxValue);
	
	var _sentiment = __webpack_require__(217);
	
	var _sentiment2 = _interopRequireDefault(_sentiment);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function mapTopicsJsonToState(topics) {
		var initialRangeValue = topics[0].volume;
		var range = topics.reduce(_reduceToMinAndMaxValue2.default, { min: initialRangeValue, max: initialRangeValue });
		var mapToState = createMapToState(range);
	...
	function createMapToState(range) {
		return function (topic) {
			return {
				...
				sentimentClass: (0, _sentiment2.default)(topic.sentimentScore)
			};
		};
	}
...
/***/ function(module, exports) {
	...
	exports.default = setSentimentClass;
	function setSentimentClass(sentiment) {
		if (typeof sentiment === 'number') {
			var positiveSentiment = 60;
			var negativeSentiment = 40;
